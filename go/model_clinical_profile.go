...
type ClinicalProfile string

// List of ClinicalProfile
const (
	OTHER ClinicalProfile = "OTHER"
	DECISION_SUPPORT ClinicalProfile = "DECISION_SUPPORT"
	DISEASE ClinicalProfile = "DISEASE"
)
