...
// Ga4ghSearchTumourboardsRequest  Tumourboard  This request maps to the body of `POST /tumourboards/search` as JSON.
type Ga4ghSearchTumourboardsRequest struct {
...
func (o Ga4ghSearchTumourboardsRequest) MarshalJSON() ([]byte, error) {
