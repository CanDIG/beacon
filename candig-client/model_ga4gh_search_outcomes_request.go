...
// Ga4ghSearchOutcomesRequest  Outcome  This request maps to the body of `POST /outcomes/search` as JSON.
type Ga4ghSearchOutcomesRequest struct {
...
func (o Ga4ghSearchOutcomesRequest) MarshalJSON() ([]byte, error) {
