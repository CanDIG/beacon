...
// Ga4ghSearchPatientsRequest  Patient  This request maps to the body of `POST /patients/search` as JSON.
type Ga4ghSearchPatientsRequest struct {
...
func (o Ga4ghSearchPatientsRequest) MarshalJSON() ([]byte, error) {
