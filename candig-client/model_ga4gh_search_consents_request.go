...
// Ga4ghSearchConsentsRequest  Consent  This request maps to the body of `POST /consents/search` as JSON.
type Ga4ghSearchConsentsRequest struct {
...
func (o Ga4ghSearchConsentsRequest) MarshalJSON() ([]byte, error) {
