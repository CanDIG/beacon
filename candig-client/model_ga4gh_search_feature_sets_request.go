...
// Ga4ghSearchFeatureSetsRequest * This request maps to the body of `POST /featuresets/search` as JSON.
type Ga4ghSearchFeatureSetsRequest struct {
...
func (o Ga4ghSearchFeatureSetsRequest) MarshalJSON() ([]byte, error) {
