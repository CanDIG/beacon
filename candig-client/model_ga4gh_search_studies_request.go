...
// Ga4ghSearchStudiesRequest  Study  This request maps to the body of `POST /studies/search` as JSON.
type Ga4ghSearchStudiesRequest struct {
...
func (o Ga4ghSearchStudiesRequest) MarshalJSON() ([]byte, error) {
