...
// Ga4ghSearchVariantsResponse This is the response from `POST /variants/search` expressed as JSON.
type Ga4ghSearchVariantsResponse struct {
...
func (o Ga4ghSearchVariantsResponse) MarshalJSON() ([]byte, error) {
