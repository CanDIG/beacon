...
// Ga4ghSearchSurgeriesRequest  Surgery  This request maps to the body of `POST /surgeries/search` as JSON.
type Ga4ghSearchSurgeriesRequest struct {
...
func (o Ga4ghSearchSurgeriesRequest) MarshalJSON() ([]byte, error) {
