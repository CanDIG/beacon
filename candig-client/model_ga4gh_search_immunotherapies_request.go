...
// Ga4ghSearchImmunotherapiesRequest  Immunotherapy  This request maps to the body of `POST /immunotherapies/search` as JSON.
type Ga4ghSearchImmunotherapiesRequest struct {
...
func (o Ga4ghSearchImmunotherapiesRequest) MarshalJSON() ([]byte, error) {
