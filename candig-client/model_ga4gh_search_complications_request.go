...
// Ga4ghSearchComplicationsRequest  Complication  This request maps to the body of `POST /complications/search` as JSON.
type Ga4ghSearchComplicationsRequest struct {
...
func (o Ga4ghSearchComplicationsRequest) MarshalJSON() ([]byte, error) {
