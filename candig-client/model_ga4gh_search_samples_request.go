...
// Ga4ghSearchSamplesRequest  Sample  This request maps to the body of `POST /samples/search` as JSON.
type Ga4ghSearchSamplesRequest struct {
...
func (o Ga4ghSearchSamplesRequest) MarshalJSON() ([]byte, error) {
