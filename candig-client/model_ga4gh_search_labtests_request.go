...
// Ga4ghSearchLabtestsRequest  Labtest  This request maps to the body of `POST /labtests/search` as JSON.
type Ga4ghSearchLabtestsRequest struct {
...
func (o Ga4ghSearchLabtestsRequest) MarshalJSON() ([]byte, error) {
