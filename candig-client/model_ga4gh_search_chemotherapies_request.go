...
// Ga4ghSearchChemotherapiesRequest  Chemotherapy  This request maps to the body of `POST /chemotherapies/search` as JSON.
type Ga4ghSearchChemotherapiesRequest struct {
...
func (o Ga4ghSearchChemotherapiesRequest) MarshalJSON() ([]byte, error) {
