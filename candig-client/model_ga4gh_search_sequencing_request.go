...
// Ga4ghSearchSequencingRequest SequencingThis request maps to the body of `POST /sequencing/search` as JSON.
type Ga4ghSearchSequencingRequest struct {
...
func (o Ga4ghSearchSequencingRequest) MarshalJSON() ([]byte, error) {
