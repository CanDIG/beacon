...
// Ga4ghSearchCelltransplantsRequest  Celltransplant  This request maps to the body of `POST /celltransplants/search` as JSON.
type Ga4ghSearchCelltransplantsRequest struct {
...
func (o Ga4ghSearchCelltransplantsRequest) MarshalJSON() ([]byte, error) {
